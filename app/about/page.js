...
import profile from "../../public/Nur.jpg"
    ...
    return (
        ...
        <section className="bg-gray-100 py-10">
            <div className="container mx-auto px-4">
                <h2 className={`text-4xl font-semibold text-center mb-6 ${titleFont.className}`}>About Me, Muhammad Nur</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="md:order-2">
                        <Image src={profile} alt="About Me" className="rounded-lg shadow-lg" />
